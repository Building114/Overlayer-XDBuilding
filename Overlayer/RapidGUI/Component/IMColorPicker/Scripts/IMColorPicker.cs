...
public class IMColorPicker : IDoGUIWindow {
    ...
    static IMColorPicker() {
        ...
        ImageLoaderCompat.LoadImage(circle, Convert.FromBase64String(""));
        rightArrow = new Texture2D(2, 2);
        ImageLoaderCompat.LoadImage(rightArrow, Convert.FromBase64String(""));
        leftArrow = new Texture2D(2, 2);
        ImageLoaderCompat.LoadImage(leftArrow, Convert.FromBase64String(""));
        button = new Texture2D(2, 2);
        ImageLoaderCompat.LoadImage(button, Convert.FromBase64String("iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAF0lEQVR42mNgIAP8JxqMahjVMNAaSAIAEz9J0wH4O8QAAAAASUVORK5CYII="));
        buttonHighlighted = new Texture2D(2, 2);
        ImageLoaderCompat.LoadImage(buttonHighlighted, Convert.FromBase64String("iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAF0lEQVR42mNgoBP4TwQY1TCqgRgNNAQAFC2uYAIOr4cAAAAASUVORK5CYII="));
