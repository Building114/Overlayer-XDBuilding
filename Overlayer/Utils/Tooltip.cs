...
public class Tooltip {
    ...
    public static Dictionary<string, string> tooltip = new() {
        ...
        ["ISCOOPMODEENABLED"] = "Displays true when more than one player is active",
        ...
        ["MAXPLAYERCOUNT"] = "Maximum supported player count for the current ADOFAI version",
        ...
        ["PLAYERCOUNT"] = "Current player count reported by ADOFAI",
